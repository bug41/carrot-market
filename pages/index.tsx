...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 xl:grid-cols-3 lg:grid-cols-2 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-500 2xl:bg-pink-500 p-6 rounded-3xl shadow-xl">
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        ...
        <div className="flex relative -top-16 items-end justify-between ">
            ...
            <div className="h-24 w-24 bg-red-400 rounded-full group-hover:bg-purple-300 transition-colors">                        
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              ...
              <button className="w-5 h-5 rounded-full bg-teal-500   focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition"/>
            </div>
