    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid pb-8 w-full mt-8 grid-cols-2 ">
            <button 
                className={cls(
          ...
          <div className="mt-1">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                <span className="flex items-center justify-center px-3 rounded-l-md border-2 border-r-0 border-gray-300 bg-gray-50 text-gray-500 select-none text-sm">+82</span>
